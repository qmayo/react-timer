...
const Events = ({eventName, changeEvent}) => {
    ...
    return (
        <div>
            <button className="button is-ghost has-text-white" value="222so" onClick={setEventHelper}>2x2x2</button>
            <button className="button is-ghost has-text-white" value="333" onClick={setEventHelper}>3x3x3</button>
            <button className="button is-ghost has-text-white" value="444wca" onClick={setEventHelper}>4x4x4</button>
           <button className="button is-ghost has-text-white" value="555wca" onClick={setEventHelper}>5x5x5</button>
            <button className="button is-ghost has-text-white" value="666wca" onClick={setEventHelper}>6x6x6</button>
            <button className="button is-ghost has-text-white" value="777wca" onClick={setEventHelper}>7x7x7</button>
            ...
            <button className="button is-ghost has-text-white" value="skbso" onClick={setEventHelper}>Skewb</button>
